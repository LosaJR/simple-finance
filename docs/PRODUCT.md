...
- Resumen es desplazable y prioriza los gastos del ciclo: un gráfico circular los distribuye por categoría, un calendario permite elegir año y mes para actualizar ese mismo resumen, y una lista muestra solo las categorías usadas, su porcentaje y su consumo frente al límite individual cuando exista. Al pulsar una categoría se abre su extracto de gastos del ciclo.
