...
- El engranaje de Ajustes conserva el tema, el día de cobro, la cantidad de nómina y los datos locales. Configuración se dedica a tarjetas, categorías y automatizaciones financieras, con selectores directos y acciones `+` para añadir tarjetas o categorías. La aplicación inicia en modo noche y permite cambiar a claro.
