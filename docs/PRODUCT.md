...
- El engranaje de Ajustes conserva el tema, el día de cobro, la cantidad de nómina y los datos locales. Configuración mantiene selectores directos para tarjetas y categorías: las altas y la edición o eliminación de categorías se realizan en hojas modales para no saturar la vista. Automatización muestra únicamente pagos recurrentes; las reglas por comercio se aplican desde el registro rápido. La aplicación inicia en modo noche y permite cambiar a claro.
